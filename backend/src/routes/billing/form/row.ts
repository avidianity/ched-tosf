...
router.post(
	...
	[
		...
		body('phoneNumber').notEmpty().withMessage('is required.').bail().isString(),
		body('laboratoryUnits').notEmpty().withMessage('is required.').bail().isString(),
		body('computerLabUnits').notEmpty().withMessage('is required.').bail().isString(),
		...
		body('computerFees').notEmpty().withMessage('is required.').bail().isString(),
...
function update() {
	return [
		[
			...
			body('phoneNumber').optional().bail().isString(),
			body('laboratoryUnits').optional().bail().isString(),
			body('computerLabUnits').optional().bail().isString(),
			...
			body('computerFees').optional().bail().isString(),
