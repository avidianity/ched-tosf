...
var Statement = /** @class */ (function (_super) {
    ...
    Statement.prototype.removeRows = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, StatementRow_1.StatementRow.getRepository().createQueryBuilder().where('statementId = :id', { id: this.id })["delete"]().execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "nameOne");
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "positionOne");
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "dateOne");
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "nameTwo");
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "positionTwo");
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Statement.prototype, "dateTwo");
    __decorate([
    ...
    ], Statement.prototype, "removeRows");
