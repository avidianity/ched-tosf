...
var BillingForm = /** @class */ (function (_super) {
    ...
    BillingForm.prototype.removeRows = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, BillingFormRow_1.BillingFormRow.getRepository()
                            .createQueryBuilder()
                            .where('formId = :id', { id: this.id })["delete"]()
                            .execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return BillingFormRow_1.BillingFormRow; }, function (row) { return row.form; }),
    ...
    ], BillingForm.prototype, "removeRows");
