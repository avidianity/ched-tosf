...
var BillingDetail = /** @class */ (function (_super) {
    ...
    BillingDetail.prototype.removeRows = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, BillingDetailRow_1.BillingDetailRow.getRepository().createQueryBuilder().where('detailId = :id', { id: this.id })["delete"]().execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ], BillingDetail.prototype, "removeRows");
