...
router.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).json;
                return [4 /*yield*/, Degree_1.Degree.find()];
            case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
        }
    });
}); });
router.post('/', [express_validator_1.body('name').notEmpty().withMessage('is required.').bail().isString()], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, name, degree, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                name = express_validator_1.matchedData(req, { locations: ['body'] }).name;
                return [4 /*yield*/, Degree_1.Degree.findOne({
                        where: {
                            name: name
                        }
                    })];
            ...
            case 3: return [2 /*return*/, res.json(degree)];
        }
    });
}); });
