...
router.post('/', [
    ...
    express_validator_1.body('degrees')
        .isArray()
        .bail()
        .customSanitizer(function (degrees) {
        return degrees.map(function (degree) { return new Degree_1.Degree({ name: degree }); });
    }),
    express_validator_1.body('year').notEmpty().withMessage('is required.').bail().isString(),
    express_validator_1.body('costPerUnit')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('coverage')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('frequentcyPerAY')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('referenceNumber')
        ...
        .bail()
        .isString(),
    express_validator_1.body('dateOfApproval')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isDate()
    ...
    express_validator_1.body('description')
        ...
        .bail()
        .isString(),
    express_validator_1.body('tosfId')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .custom(helpers_1.Validation.exists(TOSF_1.TOSF, 'id')),
...
function update() {
    ...
    return [
        [
            ...
            express_validator_1.body('frequentcyPerAY').optional().bail().isString(),
