...
router.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).json;
                return [4 /*yield*/, BillingDetail_1.BillingDetail.find({ relations: ['rows'], order: { updatedAt: 'DESC' } })];
...
router.get('/:id/export', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, billingDetail, file, binary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, BillingDetail_1.BillingDetail.findOne(id, { relations: ['rows'] })];
            case 1:
                billingDetail = _a.sent();
                if (!billingDetail) {
                    throw new NotFoundException_1.NotFoundException('Billing Form does not exist.');
                }
                return [4 /*yield*/, helpers_1.exportAsFile(req.app.get('templatesPath'), 'template-billing-detail.docx', __assign(__assign({}, billingDetail), { date: dayjs_1["default"](billingDetail.date).format('MMMM DD, YYYY'), rows: billingDetail.rows.map(function (row) { return (__assign(__assign({}, row), { birthday: dayjs_1["default"](row.birthday).format('MM/DD/YYYY') })); }) }), 'Billing Detail')];
            case 2:
                file = _a.sent();
                if (!file) {
