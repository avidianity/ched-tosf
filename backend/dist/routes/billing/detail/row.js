...
router.post('/', [
    ...
    express_validator_1.body('birthday')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isDate()
    ...
    express_validator_1.body('remarks')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('detailId')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .custom(helpers_1.Validation.exists(BillingDetail_1.BillingDetail, 'id')),
