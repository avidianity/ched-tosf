...
router.post('/', [
    express_validator_1.body('sequenceNumber')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('studentNumber')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    ...
    express_validator_1.body('givenName')
        ...
        .bail()
        .isString(),
    express_validator_1.body('middleInitial')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('degreeProgram')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    ...
    express_validator_1.body('unitsEnrolled')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('nstpUnitsEnrolled')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('tuitionFee')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('nstpFee')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('athleticFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('computeFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('culturalFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('developmentFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('admissionFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('guidanceFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('handbookFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('laboratoryFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('libraryFee')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('medicalFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('registrationFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('schoolIDFees')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('totalTOSF')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .isString(),
    express_validator_1.body('formId')
        .notEmpty()
        .withMessage('is required.')
        .bail()
        .custom(helpers_1.Validation.exists(BillingForm_1.BillingForm, 'id')),
...
function update() {
    ...
    return [
        [
            ...
            express_validator_1.body('computeFees').optional().bail().isString(),
